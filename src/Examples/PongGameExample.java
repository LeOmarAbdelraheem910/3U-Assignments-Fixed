...
public class PongGameExample extends JComponent implements ActionListener {
    ...
    int paddleWidth = 50;
    Rectangle paddle1 = new Rectangle(50, HEIGHT / 2 - paddleHeight / 2, 25, 100);
    Rectangle paddle2 = new Rectangle(725, HEIGHT / 2 - paddleHeight / 2, 25, 100);
    //ball variables
